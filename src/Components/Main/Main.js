...
export const Main = () => {
  ...
  <>
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/loginstudent"><button type="button" className="btn btn-outline-primary">Login</button></a>
            </li>
            <li className="nav-item dropdown">
    ...
    <a href="/allcity">
        <button className="btn btn-outline-success" type="button" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src={searchs} alt="search" style={{ height: '35px', width: '35px' }} />
        </button>
    </a>
</form>
...
<div className="container" style={{ marginLeft: '70px'}}>
      ...
      <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            <img src={img2} className="d-block w-100" alt="Slide 3" />
          </div>
          <div className="carousel-item">
  ...
  <h1 style={{textAlign:"center" , fontFamily:'cursive'}}>Internships / Jobs :</h1>
  <div className="container">
    <div className="row">
      <div className="col">
      ...
      <Link to="/allcity" style={{ textDecoration: 'none', color: '#008BDC', fontStyle: 'italic', fontWeight: 'bold' }}>
    <span style={{ fontSize: 'clamp(18px, 5vw, 24px)', fontFamily:'cursive' }}>View all Jobs</span>
...
<h4 style={{ fontFamily:'cursive'}}>Popular cities</h4>
<div className="cities">
  <a className="cityitem" href="/wfh">
  ...
  <a className="cityitem" href="/bang">
    <div className="cityimage">
      <img src={bang} alt="" />
    </div>
    <div className="citytext">
  ...
  <a className="cityitem" href="/hydra">
    <div className="cityimage">
      <img src={hyd} alt="" />
    </div>
    <div className="citytext">
  ...
  <a className="cityitem" href="/kolka">
    <div className="cityimage">
      <img src={kol} alt="" />
    </div>
    <div className="citytext">
  ...
  <a className="cityitem" href="/inter">
    <div className="cityimage">
      <img src={inter} alt="" />
    </div>
    <div className="citytext">
...
<h4   style={{ marginTop: '70px' , fontFamily:'cursive'}}>Popular categories</h4>
<div className="cities">
  <a className="cityitem" href="#">
    <div className="cityimage">
      <img src={part} alt="" />
...
<h2 id="itrain"  style={{ fontFamily:'cursive'}}>Internshala Placement guarantee courses :</h2>
<div className="row">
  <div className="col">
...
<h2 id="itrain" style={{ fontFamily:'cursive'}}>Internshala Certification courses for you:</h2>
<div className="cities"  style={{ marginTop: '70px' }}>
  <a className="cityitem" href="#">
    <div className="cityimage">
...
<h2 id="fjobs" style={{ fontFamily:'cursive'}}>Fresher Jobs <span>New</span></h2>
<div className="row">
  <div className="col">
...
<footer id="foo" className="container-fluid">
  ...
  <div className="foo2">
    ...
    <div className="socialsbox">
      <a href="https://www.instagram.com/internshala/?hl=en"><img className="socimg" src={instagram} alt="" /></a>
      <a href="https://twitter.com/i/flow/login?redirect_after_login=%2Finternshala"><img className="socimg" src={twitter} alt="" /></a>
